...
def export_constants(byte_counts, counts, bytes_count_map_sprites):
    ...
    with open(filename, 'w', encoding='utf-8') as f:
        ...
        f.write(f"#define SPRITE_CREATURE_FRONT_BYTES_16 {byte_counts[0]}\n")
        f.write(f"#define SPRITE_CREATURE_BACK_BYTES_16 {byte_counts[1]}\n")
        f.write(f"#define SPRITE_CREATURE_FRONT_BYTES_64 {byte_counts[2]}\n")
        f.write(f"#define SPRITE_CREATURE_BACK_BYTES_64 {byte_counts[3]}\n")
        f.write(f"#define SPRITE_SKILL_BYTES_16 {byte_counts[4]}\n")
        f.write(f"#define SPRITE_SKILL_BYTES_64 {byte_counts[5]}\n")
        f.write(f"#define SPRITE_SPELL_BYTES_16 {byte_counts[6]}\n")
        f.write(f"#define SPRITE_SPELL_BYTES_64 {byte_counts[7]}\n")
        f.write(f"#define SPRITE_ITEM_BYTES_16 {byte_counts[8]}\n")
        f.write(f"#define SPRITE_ITEM_BYTES_64 {byte_counts[9]}\n")
        f.write(f"#define SPRITE_OBJECT_BYTES_16 {byte_counts[10]}\n")
        f.write(f"#define SPRITE_OBJECT_BYTES_64 {byte_counts[11]}\n")
        f.write(f"#define SPRITE_TRAINER_BYTES_16 {byte_counts[12]}\n")
        f.write(f"#define SPRITE_TRAINER_BYTES_64 {byte_counts[13]}\n")
        f.write(f"\n")
    ...
    print(f"#define SPRITE_CREATURE_FRONT_BYTES_16 {byte_counts[0]}\n")
    print(f"#define SPRITE_CREATURE_BACK_BYTES_16 {byte_counts[1]}\n")
    print(f"#define SPRITE_CREATURE_FRONT_BYTES_64 {byte_counts[2]}\n")
    print(f"#define SPRITE_CREATURE_BACK_BYTES_64 {byte_counts[3]}\n")
    print(f"#define SPRITE_SKILL_BYTES_16 {byte_counts[4]}\n")
    print(f"#define SPRITE_SKILL_BYTES_64 {byte_counts[5]}\n")
    print(f"#define SPRITE_SPELL_BYTES_16 {byte_counts[6]}\n")
    print(f"#define SPRITE_SPELL_BYTES_64 {byte_counts[7]}\n")
    print(f"#define SPRITE_ITEM_BYTES_16 {byte_counts[8]}\n")
    print(f"#define SPRITE_ITEM_BYTES_64 {byte_counts[9]}\n")
    print(f"#define SPRITE_OBJECT_BYTES_16 {byte_counts[10]}\n")
    print(f"#define SPRITE_OBJECT_BYTES_64 {byte_counts[11]}\n")
    print(f"#define SPRITE_TRAINER_BYTES_16 {byte_counts[12]}\n")
    print(f"#define SPRITE_TRAINER_BYTES_64 {byte_counts[13]}\n")
    print(f"\n")
