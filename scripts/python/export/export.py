...
def export_constants(byte_counts, counts, bytes_count_map_sprites, bytes_count_icons, bytes_count_icons_small):
    ...
    with open(filename, 'w', encoding='utf-8') as f:
        ...
        f.write(f"#define SPRITE_CREATURE_FRONT_BYTES_64 {byte_counts[0]}\n")
        f.write(f"#define SPRITE_CREATURE_BACK_BYTES_64 {byte_counts[1]}\n")
        f.write(f"#define SPRITE_SKILL_BYTES_64 {byte_counts[2]}\n")
        f.write(f"#define SPRITE_SPELL_BYTES_64 {byte_counts[3]}\n")
        f.write(f"#define SPRITE_ITEM_BYTES_64 {byte_counts[4]}\n")
        f.write(f"#define SPRITE_OBJECT_BYTES_64 {byte_counts[5]}\n")
        f.write(f"#define SPRITE_TRAINER_FRONT_BYTES_64 {byte_counts[6]}\n")
        f.write(f"#define SPRITE_TRAINER_BACK_BYTES_64 {byte_counts[7]}\n")
        f.write(f"#define SPRITE_ENVIRONMENT_OBJECT_BYTES_64 {byte_counts[8]}\n")
        f.write(f"#define SPRITE_CREATURE_BUFF_BYTES_64 {byte_counts[9]}\n")
        f.write(f"#define SPRITE_CREATURE_DEBUFF_BYTES_64 {byte_counts[10]}\n")
        f.write(f"#define SPRITE_TRAINER_BUFF_BYTES_64 {byte_counts[11]}\n")
        f.write(f"\n")
        ...
        f.write(f"#define SPRITE_64x64_ITEM_BYTES {bytes_count_map_sprites[1]}\n")
        f.write(f"#define SPRITE_64x64_OBJECT_BYTES {bytes_count_map_sprites[2]}\n")
        f.write(f"#define SPRITE_64x64_TRAINER_BYTES {bytes_count_map_sprites[3]}\n")
        f.write(f"#define SPRITE_64x64_TILE_BYTES {bytes_count_map_sprites[4]}\n")
        f.write(f"#define SPRITE_64x64_ENVIRONMENT_OBJECT_BYTES {bytes_count_map_sprites[5]}\n")
    ...
    print(f"#define SPRITE_CREATURE_FRONT_BYTES_64 {byte_counts[0]}\n")
    print(f"#define SPRITE_CREATURE_BACK_BYTES_64 {byte_counts[1]}\n")
    print(f"#define SPRITE_SKILL_BYTES_64 {byte_counts[2]}\n")
    print(f"#define SPRITE_SPELL_BYTES_64 {byte_counts[3]}\n")
    print(f"#define SPRITE_ITEM_BYTES_64 {byte_counts[4]}\n")
    print(f"#define SPRITE_OBJECT_BYTES_64 {byte_counts[5]}\n")
    print(f"#define SPRITE_TRAINER_BYTES_64 {byte_counts[6]}\n")
    print(f"#define SPRITE_ENVIRONMENT_OBJECT_BYTES_64 {byte_counts[7]}\n")
    print(f"\n")
    ...
    print(f"#define ENVIRONMENT_OBJECT_COUNT {counts[7]}\n")

    print(f"\n")

    print(f"#define CREATURE_TEXT_ARRAY_SIZE {counts[0] + 1}\n")
    print(f"#define ABILITY_TEXT_ARRAY_SIZE {counts[1] + 1}\n")
    print(f"#define SPELL_TEXT_ARRAY_SIZE {counts[2] + 1}\n")
    print(f"#define ITEM_TEXT_ARRAY_SIZE {counts[3] + 1}\n")
    print(f"#define OBJECT_TEXT_ARRAY_SIZE {counts[4] + 1}\n")
    print(f"#define TRAINER_TEXT_ARRAY_SIZE {counts[5] + 1}\n")
    print(f"#define ENVIRONMENT_OBJECT_TEXT_ARRAY_SIZE {counts[7] + 1}\n")

    print(f"\n")

    print(f"#define NO_CREATURE {counts[0]}\n")
    print(f"#define NO_ABILITY {counts[1]}\n")
    print(f"#define NO_SPELL {counts[2]}\n")
    print(f"#define NO_ITEM {counts[3]}\n")
    print(f"#define NO_OBJECT {counts[4]}\n")
    print(f"#define NO_TRAINER {counts[5]}\n")
    print(f"#define NO_ENVIRONMENT_OBJECT {counts[7]}\n")

    print(f"#define SPRITE_64x64_CREATURE_BYTES {bytes_count_map_sprites[0]}")
    print(f"#define SPRITE_64x64_ITEM_BYTES {bytes_count_map_sprites[1]}")
    print(f"#define SPRITE_64x64_OBJECT_BYTES {bytes_count_map_sprites[2]}")
    print(f"#define SPRITE_64x64_TRAINER_BYTES {bytes_count_map_sprites[3]}")
    print(f"#define SPRITE_64x64_TILE_BYTES {bytes_count_map_sprites[4]}")
    print(f"#define SPRITE_64x64_ENVIRONMENT_OBJECT_BYTES {bytes_count_map_sprites[5]}\n")

    print(f"#define SPRITE_80x80_SKILL_BYTES {bytes_count_icons[0]}\n")
    print(f"#define SPRITE_80x80_SPELL_BYTES {bytes_count_icons[1]}\n")
