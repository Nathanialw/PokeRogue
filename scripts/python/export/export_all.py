...
def run():
    ...
    export.func_c_headers("tile", "TIleStepOff", "bool", "HardwareInterface hardware, MemoryInterface memory, AudioInterface audio, EntityId id, ObjectsTypes type, uint8_t x, uint8_t y")
