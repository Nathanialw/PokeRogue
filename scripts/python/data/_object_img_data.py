...
ObjectsDict = [
   ...
   { "name": 'CABINET_BOOK', 'prompt': "The book's leather cover shimmers with enchanted runes, and its pages shift like living shadows when touched."},
   { "name": 'CABINET_JEWELLERY', 'prompt': "A delicate silver circlet adorned with glowing sapphires, humming with ancient enchantments when worn by moonlight."},
   { "name": 'CABINET_SCROLL', 'prompt': "A shimmering, ancient scroll hums with arcane energy, its edges singed with golden runes and glowing faintly in the dim light."},
   ...
   { "name": 'SHRINE_MIVERNA', 'prompt': "SHRINE_MIVERNA"},
   { "name": 'SHRINE_POSEIDON', 'prompt': "SHRINE_POSEIDON"},
   { "name": 'SHRINE_SAINT_MARY', 'prompt': "SHRINE_SAINT_MARY"},
