...
CREATURE_VALIDATION = {
    ...
    "Anlaf": {
        "required_terms": ["English", "strong", "man"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Antonio": {
        "required_terms": ["Spanish", "male", "strong", "catholic"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Athelric": {
        "required_terms": ["anglo-saxon", "strong", "dutiful", "noble", "male", "man"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Aylward": {
        "required_terms": ["male", "strong", "shield", "guardian", "noble", "english"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },

    "Bernard": {
        "required_terms": ["bear pelt cloak", "French", "dark hair"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Chunho": {
        "required_terms": ["Korean", "man", "strong"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },

    "Coenwulf": {
        "required_terms": ["wearing a wolfskin", "powerful", "man"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Edwin": {
        "required_terms": ["male", "strong", "wealthy", "english"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Godwyn": {
        "required_terms": ["male", "crusader", "strong", "knight", "English", "sword", "shield"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Gyrid": {
        "required_terms": ["Monk", "man", "strong", "christian"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Hardred": {
        "required_terms": ["male", "strong", "english"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Masamune": {
        "required_terms": ["Japanese", "man", "samurai", "strong"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },

    "Matilda": {
        "required_terms": ["German", "light brown hair", "warrior"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Niall": {
        "required_terms": ["Irish", "champion", "handsome"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Paige": {
        "required_terms": ["male", "squire", "boy", "warrior"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Thryth": {
        "required_terms": ["Man", "strong", "powerful", "anglo-saxon"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
    ...
    "Winston": {
        "required_terms": ["anglo-saxon", "man", "strong", "powerful"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },

    "Wulfstan": {
        "required_terms": ["anglo-saxon", "man", "strong", "powerful", "wolf pelt clothes"],
        "forbidden_terms": ["ugly"],
        "min_matches": MIN_MATCHES
    },
