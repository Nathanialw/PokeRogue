...
VIEW_ANGLES = [ "strict angled front view, 45 degree lateral pose, full debuff in frame", "strict subject turned slightly askew, front view, 45 degree lateral pose, full debuff in frame", "front  three-quarter view, mostly front but slight side visible", ]
